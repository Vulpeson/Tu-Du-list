...
function checkall () {
    ...
    let checkallarray = document.getElementsByClassName("tu-du-list-item");
...
function checkactive () {
    ...
    let checkactivearray = document.getElementsByClassName("tu-du-list-item");
    let checkactivearraycheckbox = document.getElementsByClassName("tu-du-input");
...
function checkcompleted () {
    ...
    let checkcompletedarray = document.getElementsByClassName("tu-du-list-item");
    let checkcompletedarraycheckbox = document.getElementsByClassName("tu-du-input");
...
let green_my_array = document.getElementsByClassName("tu-du-list-item");


function green_my_list_item (j) {

    let green_this = document.getElementById(j);
    green_this.parentNode.parentNode.childNodes[3].classList.toggle('tu-du-text-green');

    green_this.parentNode.parentNode.childNodes[5].childNodes[1].classList.toggle("tu-du-buton-red");
    green_this.parentNode.parentNode.childNodes[5].childNodes[1].classList.toggle("tu-du-buton-green");
...
console.log(document.getElementsByClassName("tu-du-list-item").length-1)

function tuducount (){
    document.getElementById("tu-du-counter").textContent = 'total taskuri: ' + (document.getElementsByClassName("tu-du-list-item").length-1)
...
function checkemall(){
    ...
    tasks_status = document.getElementsByClassName('tu-du-input');
    ...
    document.getElementById("tu-du-title").classList.toggle('rainbow')
    document.getElementsByClassName('tu-du-footer')[0].classList.toggle('rainbow')
